...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{../benchmarks/pdf/fastmarching_benchmark.pdf}

	\end{center}
	\begin{center}
		\includegraphics[width=0.95\textwidth]{../benchmarks/pdf/jetmarching_benchmark.pdf}

	\end{center}

	\caption{Comparison of Fast Marching and Jet Marching Algorithmic Complexity, log-log plots}\label{fig:comp}
\end{figure}
Dans la Figure \ref{fig:comp} on présente une comparaison de la vitesse (expérimentale)
